...
export class BlocksController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Block created successfully', type: BlockResponseDto })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Blocks retrieved successfully', type: [BlockResponseDto] })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Block retrieved successfully', type: BlockResponseDto })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Block updated successfully', type: BlockResponseDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Block not found' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Duplicate order in module' })
  async update(
  ...
  @ApiResponse({ status: HttpStatus.NO_CONTENT, description: 'Block deleted successfully' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Block not found' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Blocks reordered successfully', type: [BlockResponseDto] })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Module not found' })
  async reorderBlocks(
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Answer created successfully', type: BlockAnswerResponseDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Block not found' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Answer updated successfully', type: BlockAnswerResponseDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Answer not found' })
  async updateAnswer(
    @Param('id', ParseIntPipe) id: number,
  ...
  @ApiResponse({ status: HttpStatus.NO_CONTENT, description: 'Answer deleted successfully' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Answer not found' })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Relational pair created successfully', type: RelationalPairResponseDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Block not found' })
  async createRelationalPair(@Body() createPairDto: CreateRelationalPairDto) {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Relational pair updated successfully', type: RelationalPairResponseDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Relational pair not found' })
  async updateRelationalPair(
    @Param('id', ParseIntPipe) id: number,
    @Body() updateData: Partial<CreateRelationalPairDto>,
  ) {
  ...
  @ApiResponse({ status: HttpStatus.NO_CONTENT, description: 'Relational pair deleted successfully' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Relational pair not found' })
