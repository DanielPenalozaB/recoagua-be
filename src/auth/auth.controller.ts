import { Controller, Post, Body, Get, UseGuards, Req, Patch, Request } from '@nestjs/common';
...
export class AuthController {
  ...
  @ApiResponse({ status: 400, description: 'Invalid token or email already confirmed' })
